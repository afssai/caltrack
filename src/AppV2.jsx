        ...
        body: JSON.stringify({
          ...
          daily: {
            ...
            profile: {
              ...
              neck: data.profile.neck,
              goalWeight: data.profile.goalWeight,
              goalMode: data.profile.goalMode || "lose",
            ...
            computed: {
              ...
              fatMassKg,
              projectedWeeklyLoss,
              proteinFloorMin: leanMassKg ? Math.round(leanMassKg * 1.6) : null,
              proteinFloorMax: leanMassKg ? Math.round(leanMassKg * 2.0) : null,
            },
            targets: {
            ...
            foodItems: items.map((e) => ({ name: e.name, meal: e.meal, calories: e.calories, protein: e.protein, carbs: e.carbs, fat: e.fat, fiber: e.fiber })),
            totals,
            water: dailyLog.water,
            activities: dailyLog.activities,
            healthFlags: dailyLog.healthFlags,
            notes: dailyLog.notes,
            recentWeights: weightEntries.slice(-5).map((e) => ({ date: e.date, weight: e.weight })),
            remainingCalories: netRemaining,
          },
        }),
      });
      if (!response.ok) {
